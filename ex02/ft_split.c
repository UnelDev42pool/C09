...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/17 13:44:00 by edi-iori          #+#    #+#             */
/*   Updated: 2023/07/21 10:30:05 by edi-iori         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int	count_words(char *str, char *charset)
{
	...
	while (str[i] != '\0')
	{
		if (char_is_separator(str[i + 1], charset)
			&& !char_is_separator(str[i], charset))
			words++;
		i++;
	}
	return (words);
...
// 	int i  = 0;
// 	char *truc = ",.";
// 	char **bin = ft_split("hello,.world", truc);
// 	while(i < 2)
// 	{
// 		printf("%s\n", bin[i]);
// 		i++;
